...
title.innerText = "Click on the Pokeball to find your Pokemon's name!";
...
Object.entries(pokemon.sprites)
  ...
  .forEach((item) => displayPoke(item));

function displayPoke(item) {
  const pic = document.createElement('div');
  pic.setAttribute('class', 'spriteDiv');
  main.append(pic);
...
main.addEventListener('click', function () {
  alert('Your Pokemon is Squirtle!');
});
